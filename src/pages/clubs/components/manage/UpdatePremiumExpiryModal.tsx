...
import { ChevronRightIcon, XIcon } from "@/icons/figma-icons";

interface UpdatePremiumExpiryModalProps {
  open: boolean;
...
export function UpdatePremiumExpiryModal({
  open,
  onOpenChange,
  currentExpiryDate,
  onConfirm,
  isSubmitting = false,
}: UpdatePremiumExpiryModalProps) {
          ...
          <div className="flex flex-col gap-[18px]">
            <div className="flex items-center justify-between">
              ...
              <DialogClose asChild>
                <button
                  type="button"
                  className="inline-flex h-8 w-8 items-center justify-center rounded-[8px] border border-[rgba(0,0,0,0.15)] bg-white text-[#010a04]/70 transition-colors hover:bg-[#f5f7f6] hover:text-[#010a04] focus-visible:outline-none focus-visible:ring-0"
