...
export function UserInformationHeader() {
  ...
  return (
    <div className="border-b border-[#e5e7eb] px-4 sm:px-6 pt-4 pb-4 flex items-center justify-between gap-3">
      <div>
        <h1 className="sr-only text-lg font-semibold text-foreground lg:not-sr-only lg:block">
          {t("signup.title")}
        </h1>
        <p className="text-sm text-muted-foreground lg:mt-1">{t("signup.subtitle")}</p>
      </div>
