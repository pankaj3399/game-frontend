  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent
        ...
        className="max-h-[calc(100dvh-16px)] max-w-[min(100vw-1rem,390px)] min-w-0 gap-0 overflow-x-clip overflow-y-auto rounded-[12px] border border-brand-primary/20 px-2.5 py-2.5 shadow-sm shadow-brand-primary/15 sm:max-h-[calc(100dvh-24px)] sm:max-w-[min(100vw-2rem,515px)] sm:px-[15px] sm:py-4 [&>*]:min-w-0"
        showCloseButton
      >
        ...
        <Tabs defaultValue="basic" className="w-full min-w-0 max-w-full overflow-x-clip">
          <TabsList className="mt-2.5 w-full min-w-0 max-w-full bg-brand-primary/10 sm:mt-4 sm:w-fit">
          ...
          <div className="min-w-0 max-w-full overflow-x-clip py-2.5 sm:py-4">
