...
export function StaffAvatar({ name, alias }: { name: string | null; alias: string | null }) {
...
export function StaffRow({
    ...
    member: { id: string; email: string; name: string | null; alias: string | null; role: string; roleLabel: string };
